...
# Set the backend to use TensorFlow (optional, since it's the default)
from stable_baselines3.common.envs import DummyVecEnv
stable_baselines3.common.cmd_util.USE_TORCH = False

TRAIN = True

if __name__ == "__main__":
    # Create the environment
    env = DummyVecEnv([lambda: gym.make("merge-v0", render_mode="rgb_array")])
